  ...
  resource :next do 
	...
	resource :search do
		...
		resource :photos do
			...
			get '/' , jbuilder: 'photos' do
				@photos = Photo.all.limit(params[:limit]).offset(params[:offset])
			end
		end
		...
		resource :houses do
			...
			get '/' , jbuilder: 'houses' do
				@houses = House.all.limit(params[:limit]).offset(params[:offset])
			end
		end
		...
		resource :architects do
			...
			get '/' , jbuilder: 'architects' do
				@architects = Architect.all.limit(params[:limit]).offset(params[:offset])
			end
		end
	end
end
