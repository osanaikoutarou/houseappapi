...
Photo.create(:id=>'012', :uuid=>'212121', :title=>'たいとる', :image_url=>'がぞうurl', :liked_count=>123, :passed_count=>234, :description=>'説明文');
Photo.create(:id=>'013', :uuid=>'abcdef', :title=>'タイトル', :image_url=>'がぞうurl', :liked_count=>123, :passed_count=>234, :description=>'説明文');
